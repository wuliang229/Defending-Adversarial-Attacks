...
from Step3_Train_Autoencoder import autoencoder
...
class DefenseNet(nn.Module):
    def __init__(self):
        ...
        #  # experiment 100
        # self.ae1 = nn.Linear(200, 50)
        # self.ae2 = nn.Linear(50, 200)

        # experiment 50
        self.ae1 = nn.Linear(200, 10)
        self.ae2 = nn.Linear(10, 200)
...
if __name__ == '__main__':
    ...
    dfnet.ae2.weight = torch.nn.Parameter(model_ae.state_dict()['decoder.0.weight'])
    dfnet.ae2.bias = torch.nn.Parameter(model_ae.state_dict()['decoder.0.bias'])

    torch.save(dfnet, 'DefenseNet.pth')
    print('DefenseNet saved')
